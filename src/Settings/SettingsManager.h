...
class FuelCellIndicatorSettings;
...
class SettingsManager : public QObject
{
    ...
    Q_MOC_INCLUDE("FuelCellIndicatorSettings.h")
#ifdef QGC_VIEWER3D
    ...
    Q_PROPERTY(QObject *fuelCellIndicatorSettings       READ fuelCellIndicatorSettings      CONSTANT)
#ifdef QGC_VIEWER3D
...
public:
    ...
    FuelCellIndicatorSettings *fuelCellIndicatorSettings() const;
#ifdef QGC_VIEWER3D
...
private:
    ...
    FuelCellIndicatorSettings *_fuelCellIndicatorSettings = nullptr;
#ifdef QGC_VIEWER3D
